...
public partial class ViewStud : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlConnection cn = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Admin\Documents\Visual Studio 2010\WebSites\Rushik_asp\CRUDProcedure\App_Data\Student.mdf;Integrated Security=True;User Instance=True");
        cn.Open();
        ...
        SqlCommand cmd = new SqlCommand("ViewStud", cn);
