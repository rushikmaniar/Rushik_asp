<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Arith_radio.aspx.cs" Inherits="Arith_radio" %>
...
<body>
    ...
    <div class="row">
        <table border="2" class="table-hover col-sm-4">
            <tr>
                <td>
                    Enter 1st No
                </td>
           ...
           <!--
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Button CssClass="btn-lg btn-primary" PostBackUrl="~/arit_radio_calc.aspx" ID="cmd_submit" Text="submit" runat="server" />
                </td>
            </tr>
        </table>
    </div>
